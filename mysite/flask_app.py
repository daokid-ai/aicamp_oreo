...
names_path = os.path.join(here, 'yolo', 'obj.names')
...
weights_path = os.path.join(here, 'yolo', 'my-yolov3-tiny-obj_final.weights')
# cfg_path = os.path.join(here, 'yolo', 'clem-yolov3.cfg')
cfg_path = os.path.join(here, 'yolo', 'my-yolov3-tiny-obj.cfg')
